...
// $(window).load(function() {
//   $("#my-wrapper").removeClass("preload");
// });
...
//             console.log('WTF????');
//          $(".preloader2").delay(1500).fadeOut();
//          // $(".overlay-loader").delay(3300).fadeOut("slow");
//          $("#my-wrapper").delay(1500).fadeIn();
};
